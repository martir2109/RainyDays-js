...
async function fetchProductById(productId) {
  ...
  try {
    ...
    function showProductDetails(product) {
      document.getElementById("product-page-title").textContent =
        product.title || "No title available";
      document.getElementById("product-page-image").src =
        product.image?.url || "../images/logo/rainydays-logo.png";
      document.getElementById("product-details").innerHTML = `
          ...
          <p>Price: ${
            product.price
              ? product.price + "$ incl. Taxes"
              : "Price not available"
          }</p>
        `;
      document.getElementById("description").textContent =
        product.description || "No description available";
      document.getElementById("tags").textContent = product.tags?.length
        ? product.tags.join(", ")
        : "No tags available";
    }
    ...
    document
      .querySelector(".product-add-to-cart-button")
